            ...
            <div class="mid-con">
                <div class="card-main shadow-lg p-3 mb-5 rounded" style="width: 30rem;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="../validation/val-signin.php" method="POST" class="row g-3 needs-validation"
                            novalidate>
                            <div class="mb-1 mail">
                            <i class="fa-solid fa-unlock-keyhole ms-3 mt-3 opacity-50"></i>
                                    <input type="password" class="form-control" name="signEmail" placeholder="Enter OTP"
                            ...
                            <?php if($_SESSION['log_signin_error']==true) {
                                    ?>
